      ...
      {isPending ? (
        ...
        isLocalHost ? (
          ...
          >
            ...
            <Typography sx={{ fontSize: "0.88rem", color: "text.secondary" }}>
              Make sure the PyIPv8 node is running on port 8080. (
              {error.message})
            </Typography>
          </Box>
        ) : (
          ...
          >
            ...
            >
              ...
              local blockchain node, both of which run on your own machine not
              this hosted page. Run the project locally to see live ticket data
        ...
        <Grid container spacing={2.5}>
          {tickets.map((ticket) => (
            ...
            >
              <TicketCard ticket={ticket} isConnected={isConnected} />
            </Grid>
          ))}
        </Grid>
      ) : (
